...
class DataProcessor:
    ...
    def __init__(self, tokenizer_type: str = "chinese_bpe", vocab_path: Optional[str] = None, 
                 vocab_size: int = 50000, config_path: Optional[str] = None):
        """
        初始化数据处理器
        ...
        if tokenizer_type == "chinese_bpe" and create_chinese_tokenizer:
            ...
            self.tokenizer = create_chinese_tokenizer(vocab_size=vocab_size)
        ...
        try:
            ...
            if self.config and 'data' in self.config:
                ...
                if 'vocab_size' in data_config:
                    self.target_vocab_size = data_config['vocab_size']
