...
from infer import LLMInference3B, sample_next_token


class ChatBot3B:
    """3B模型聊天机器人"""
    
    def __init__(self, model_dir="model_save", config_path="config/config.yaml"):
        """初始化3B聊天机器人"""
...
def main():
    ...
    parser.add_argument('--model-dir', default='model_save', help='模型保存目录')
    ...
    try:
        ...
        print("💡 或者使用不同的参数:")
        print("   python chat_3b.py --model-dir model_save --config config/config.yaml")
